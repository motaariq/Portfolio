...
class Footer extends StatelessWidget {
  ...
  final String _description =
      "I am developer has around 3 years experience developing mobile applications, using different languages and techniques.";
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Text(
                  'Proudly powered by Motariq ©${DateTime.now().year}',
                  style: TextStyle(
                    color: AppColors.greyLight!.withOpacity(.75),
                  ),
                ),
